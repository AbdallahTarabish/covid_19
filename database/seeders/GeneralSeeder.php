...
///////////////////////
        ...
        DB::table('advice')->insert([
            "headline" => "Gatherings",
            "subtitle" => "Indoor gatherings are limited to a maximum of 6 people unless an exception applies.Outdoor gatherings are limited to a maximum of 30 people unless an exception applies.",
            "image" => "advice1.png"
        ]);
